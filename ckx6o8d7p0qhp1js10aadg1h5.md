...
But the question is how can we determine level of coupling for a given component? Above definitions don't bring the straightforward answer. To answer this question we must divide coupling concept into two aspects:
- quantitative
- qualitative
...
In the following examples we use also four questions to determine how implementation of sending notification is coupled with business action (The more 'yes' answers, the coupling is tighter): 
