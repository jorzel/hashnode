...
seoTitle: "Working Hard Isn't Enough"
...
And critically: when natural feedback is broken or absent, you must **construct it artificially**.

You create feedback through:

* **Writing** (forces clarity—if you can't explain it, you don't understand it. Decision journals are powerful here: record your reasoning before outcomes, so you can evaluate process separately from results)
    
* **Teaching** (reveals gaps in your thinking)
    
* **Peer review** (find people who challenge your thinking)
    
* **Metrics** (in software architecture, you can't wait years, so you instrument: latency, error rates, throughput—though generating *insightful* metrics is itself an art)
